...
def create_standard_localized_files(hk4e_folder='hk4e', output_base='beyond/limited'):
    ...
    for filename in files:
        if filename.startswith('2000_beyond_') and filename.endswith('.json'):
            # Extract language code
            # 2000_beyond_en-us.json -> en-us
            lang = filename.replace('2000_beyond_', '').replace('.json', '')
